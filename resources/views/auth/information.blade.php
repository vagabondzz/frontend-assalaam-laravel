...
<div class=" w-full overflow-y-hidden sm:ml-64 overflow-x-hidden">
    ...
    <div class=" mt-20 mb-2 py-6 mx-4 card rounded-lg h-screen shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="flex justify-start text-white">
            <div class="hidden sm:block absolute rounded-full top-1 -right-10"> <img src="{{ asset('images/inf.png') }}"
                    class="w-[500px] relative  animate-fadeIn " alt=""></div>
            <img src="{{ asset('images/inf.png') }}" class="w-[350px] -mt-4 relative block sm:hidden animate-fadeIn "
                alt="">
        </div>
        <div class="text-white flex flex-col sm:mt-14 p-2 sm:p-6">
            <span class="hidden sm:block font-bold text-5xl text-[#019A4C]">Terimakasih {{ Auth::user()->name }},</span>
            <span class="block sm:hidden font-bold text-3xl text-[#019A4C]">Terimakasih {{ Auth::user()->name }},</span>
            <span class="hidden sm:block font-bold text-[40px] -mt-2 text-orange-400">Sudah mendaftar <br>
                <p class="-mt-4"> Member
                    PAS </p>
            </span>
            <span class="block sm:hidden font-bold text-4xl -mt-1 text-orange-400">Sudah mendaftar <p class="-mt-2">
                    Member
                    PAS </p></span>
            <p class="block sm:hidden ml-1 dark:text-gray-50 text-gray-800">Untuk mengaktifkan kartu member dan
            ...
            <p class="hidden sm:block dark:text-gray-50 text-gray-800">Untuk mengaktifkan kartu member dan
                menikmati layanan
            </p>
            <p class="hidden sm:block dark:text-gray-50 text-gray-800"> di web ini silahkan datang
                langsung ke ASSALAAM HYPERMARKET
            </p>
            <p class="hidden sm:block dark:text-gray-50 text-gray-800"> untuk menemui
                Customer Service dan melakukan pengaktifan</p>
    ...
    <dialog id="inf" class="modal ">
        <div class="modal-box overflow-hidden">
            ...
            <h3 class="text-lg font-bold">Lokasi Assalam Hypermarket</h3>
